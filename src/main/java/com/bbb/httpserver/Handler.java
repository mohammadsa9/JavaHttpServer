...
public class Handler implements HttpHandler {
    ...
    public void handle(HttpExchange t) throws IOException {
        ...
        if (requestedFile.isFile()) {
            ...
            // responseHeader.add("Content-Type", 200);
            ...
            response.append("<html><head><title>ls</title>" + "<style type=\"text/css\">"
                    + " body {font-family: Monospace; font-size: 14px;}" + "</style>"
                    + "</head><body><h1>local-share</h1>" + "<h4><a href=\"http://www.vishesh-yadav.com\">"
                    + "Vishesh Yadav</a></h4>");
